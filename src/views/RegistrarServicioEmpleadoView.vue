...
<template>
  <v-app>  
    <VAppBar app color="#1a1a1a" dark>
      <router-link to="/MenuVehiculosEmpleados">
        <v-btn color="white" icon="mdi-arrow-left-bold-circle-outline"></v-btn>
      </router-link>
      <h1 class="titulo-vehiculos text-center w-100">REGISTRAR SERVICIO</h1>
    </VAppBar>
        ...
        <v-card-text>
          <v-container>
            <v-form ref="form" v-model="valid">
                <v-col>
                    ...
                    <v-row>
                        ...
                        <v-col>
                            <v-text-field
                            v-model="garantia"
                            :rules="[v => !!v || 'Garantía es requerido']"
                            label="Garantia"
                            variant="solo"
                            ></v-text-field>
                        </v-col>
                ...
                <v-btn id="btn-registrar"  color="#1a1a1a" @click="submit">
                    Registrar
                </v-btn>
            </v-form>
          </v-container>
...
.container {
  ...
  align-items: center;
  margin-top: 30px; /* Ajustar según la altura del VAppBar */
