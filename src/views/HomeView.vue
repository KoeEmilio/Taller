    ...
    <header id="inicio">
      <div class="header__contenedor">
        ...
        <div class="navegacion">
          ...
          <v-btn variant="plain" class="navegacion__letras" @click="clickconocenos">Conócenos</v-btn>
        ...
        <div class="usuario">
          <a href="#" class="usuario__icon">
            <router-link to="/Login">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user" width="35" height="35" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
